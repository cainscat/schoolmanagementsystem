                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-3">
                                        ...
                                        <a href="{{ url('teacher/attendance/student') }}" style="margin-top: 23px;" class="btn btn-success">Reset</a>
                                    </div>
                                            ...
                                            @endphp
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <label>
                                                            <input value="4" type="radio" {{ ($attendance_type == 4) ? 'checked' : '' }} id="{{ $value->id }}" class="SaveAttendance" data-class="" name="attendance{{ $value->id }}"> Half Day
                                                        </label>
                                                    </td>
                                                </tr>
                                            @endforeach
