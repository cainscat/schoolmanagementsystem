                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-2">
                                        ...
                                        <a href="{{ url('admin/homework/homework') }}" style="margin-top: 23px;" class="btn btn-success">Reset</a>
                                    </div>
                                ...
                                <tbody>
                                    @forelse($getRecord as $value)
                                        <tr class="align-middle">
                                            ...
                                            <td>
                                                <a href="{{ url('teacher/homework/homework/edit/'.$value->id) }}" class="btn btn-primary"><i class="bi bi-pencil-square"></i></a>
                                                <a href="{{ url('teacher/homework/homework/delete/'.$value->id) }}" class="btn btn-danger"><i class="bi bi-trash3-fill"></i></a>
                                                <a href="{{ url('teacher/homework/homework/submitted/'.$value->id) }}" class="btn btn-success">Submitted</a>
                                            </td>
                                        </tr>
                                    @empty
                                        <tr>
