...
<main class="app-main">
    <div class="app-content-header">
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-12">
                    <h3 class="mb-0">Homework Reprot</h3>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="col-md-12">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-2">
                                        ...
                                        <a href="{{ url('admin/homework/homework_report') }}" style="margin-top: 23px;" class="btn btn-success">Reset</a>
                                    </div>
                    ...
                    <div class="card mb-4 mt-3">
                        <div class="card-header">
                            <h3 class="card-title">Homework Reprot List</h3>
                        </div>
