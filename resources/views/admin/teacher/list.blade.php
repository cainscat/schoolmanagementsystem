                                    ...
                                    @foreach ($getRecord as $value)
                                        <tr class="align-middle">
                                            ...
                                            <td style="min-width: 120px;">
                                                <a href="{{ url('admin/teacher/edit/'.$value->id) }}" class="btn btn-primary"><i class="bi bi-pencil-square"></i></a>
                                                <a href="{{ url('admin/teacher/delete/'.$value->id) }}" class="btn btn-danger"><i class="bi bi-trash3-fill"></i></a>
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
