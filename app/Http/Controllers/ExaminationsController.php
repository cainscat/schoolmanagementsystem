...
class ExaminationsController extends Controller
{
    ...
    public function submit_marks_register(Request $request)
    {
        ...
        {
            $json['message'] = "Marks Register successfully saved. But, Some subject marks greather than full marks!";
        }
    ...
    public function single_submit_marks_register(Request $request)
    {
        ...
        {
            $json['message'] = "Your total marks greather than full marks!";
        }
    ...
    public function my_exam_result_print(Request $request)
    {
    ...
    //teacher side
    public function my_exam_timetable_teacher()
    {
        $result = array();
    ...
    public function parent_my_exam_result($student_id)
    {
        $data['getStudent'] = User::getSingle($student_id);
        $result = array();
